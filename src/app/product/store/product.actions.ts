...
export const loadProductDetails = createAction('[Product] Load Product Details', props<{ productId: number }>());
export const loadProductDetailsSuccess = createAction('[Product] Load Product Details Success', props<{ product: Product }>());
export const LoadProductDetailsFailure = createAction('[Product] Load Product Details Failure', props<{ error: string }>())
